...
class BasinsLoc:
    def __init__(
        self,
        epsilon=1e0,
        next_step_search_budget=50,
        next_step_search_sigma=0.1,
        next_step_search_lb_sigma=0.01,
        next_step_search_T=5,
        next_step_search_gamma=1.027457,
        is_verbose=False,
    ):
        self.MIN_DIST = epsilon
        self.next_step_search_budget = next_step_search_budget
        self.next_step_search_sigma = next_step_search_sigma
        self.next_step_search_lb_sigma = next_step_search_lb_sigma
        self.next_step_search_T = next_step_search_T
        self.next_step_search_gamma = next_step_search_gamma
    ...
    def find_step(self, p1, v1, p2, v2, f, R, alg="opoES"):
        ...
        x, value = self.opoES(
            ...
            x0,
            v1,
            self.next_step_search_budget,
            self.next_step_search_sigma,
            self.next_step_search_lb_sigma,
            self.next_step_search_T,
            self.next_step_search_gamma,
        )
